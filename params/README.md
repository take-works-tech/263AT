...
|---|---|
| パラメータ | 769 |
| verified | **118** = ★★★ 20 + ゲート 26 + **O 全24** + **B main 15** + **A main 24** + **C main 20** |
| draft | 651 |
...
| 問 | 残り | 備考 |
|---|---|---|
| q06 欠損の偏り | 651 | 全件で個別判断が要る |
| q09 相関 | 651 | データを見ないと答えられない。Phase 1 の相関行列（Z12）待ち |
| q10 経済的理由 | 651 | **人が書くしかない。ここが最も重要** |
| q11 実証度と一次文献 | **513** | OSAP 突合 188 + 人手レビュー 118 |
| q12 日米差 | 595 | |
| q05 分母ゼロ | 233 | 除算を含むもの |
...
5. M（株主構成 0.09）と N（カタリスト 0.07）の main ← **次はここ**
6. 残り

...
MODULES = ["guard.py", "bars.py", "universe.py", "normalize.py", "listing.py", "ff49.py", "facts.py", "periods.py", "prices.py", "params_us.py", "params_px.py", "factors.py", "params_fx.py", "prior.py", "knowledge.py", "extern.py", "entity.py", "pipeline.py",
